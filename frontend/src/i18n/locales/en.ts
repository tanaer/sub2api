  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        useKeyInstructions: 'Use Key Instructions',
        platform: 'Platform',
        rateMultiplier: 'Rate Multiplier',
        status: 'Status',
      ...
      useKeyInstructionsPlaceholder: 'Optional. When set, this copy is shown at the top of the user-side Use Key modal and replaces the default instructions.',
      useKeyInstructionsHint: 'Customize API key usage instructions per group, such as onboarding notes, caveats, or dedicated setup requirements.',
    ...
    accounts: {
      ...
      tempUnschedulable: {
        ...
        upstreamStatusCode: 'Actual Upstream Status Code',
        upstreamErrorMessage: 'Upstream Error Message',
    ...
    ops: {
      ...
      requestTrace: {
        title: 'Request Trace',
        empty: 'No request trace data',
        failedToLoad: 'Failed to load request trace',
        copied: 'Identifier copied',
        copyFailed: 'Copy failed',
        incomplete: 'Trace did not finish cleanly',
        ambiguousTitle: 'This identifier matched multiple request traces',
        ambiguousHint: 'Choose one of the candidate client_request_id values below to continue.',
        useCandidate: 'Open Trace',
        notFound: 'Request trace not found',
        notFoundHint: 'Try client/local/usage/upstream identifiers instead.',
        timelineEmpty: 'No trace events',
        timelineCount: 'events',
        noEventData: 'No additional data',
        boolean: {
          yes: 'Yes',
          no: 'No'
        },
        ...
        fields: {
          ...
          queryKeyType: 'Query Type',
          matchedBy: 'Matched By',
          clientRequestId: 'Client Request ID',
          localRequestId: 'Local Request ID',
          usageRequestId: 'Usage Request ID',
          upstreamRequestIds: 'Upstream Request IDs',
          originalRequestedModel: 'Original Requested Model',
          groupResolvedModel: 'Group Resolved Model',
          accountSupportLookupModel: 'Account Lookup Model',
          finalUpstreamModel: 'Final Upstream Model',
          ...
          finalStatusCode: 'Final Status Code',
          finalAccount: 'Final Account',
          finalAccountId: 'Final Account ID',
          traceIncomplete: 'Trace Completeness'
        }
      },
      alertEvents: {
        title: 'Alert Events',
    ...
    settings: {
      ...
      modelIdentity: {
        title: 'Model Identity Masking',
        description: 'Control how upstream model identity information is intercepted and rewritten',
        localResponseEnabled: 'Local Response',
        localResponseEnabledHint: 'When an identity question is detected, return a masked reply locally without forwarding to upstream.',
        instructionInjectionEnabled: 'Instruction Injection',
        instructionInjectionEnabledHint: 'Inject identity answer constraints into the request system prompt.',
        responseRewriteEnabled: 'Response Rewrite',
        responseRewriteEnabledHint: 'Scan upstream responses and replace identity leaks. Uses keyword matching (strict) for identity questions, regex pattern matching (loose) for normal requests.',
        hitWordsTitle: 'Hit Words',
        hitWordsHint: 'Keywords for strict mode. When the user asks an identity question, responses containing these words trigger rewriting.',
        hitWordsPlaceholder: 'Type a keyword and press Enter',
        identityPatternsTitle: 'Identity Patterns (Regex)',
        identityPatternsHint: 'Regular expressions for loose mode (one per line). For non-identity questions, only these sentence patterns trigger rewriting.',
        identityPatternsPlaceholder: 'One regex pattern per line',
        replyTemplateTitle: 'Reply Template',
        replyTemplateHint: 'Supports {company} and {model} placeholders, auto-filled based on the requested model name.',
        replyTemplatePlaceholder: 'I am a {model} LLM trained by {company}...',
        resetDefaults: 'Reset to Defaults',
        resetDefaultsConfirm: 'Are you sure you want to reset to default settings?',
      },
      healthBreaker: {
