...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "request_quota", Type: field.TypeInt64, Default: 0},
		{Name: "request_quota_used", Type: field.TypeInt64, Default: 0},
	...
	APIKeysTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "apikey_request_quota_request_quota_used",
				Unique:  false,
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "upstream_provider", Type: field.TypeString, Nullable: true, Size: 50},
	...
	AccountThrottleRulesColumns = []*schema.Column{
		...
		{Name: "recovery_check_interval", Type: field.TypeInt, Default: 0},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "use_key_instructions", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "config_templates", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		...
		{Name: "model_aliases", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "fallback_model", Type: field.TypeString, Size: 100, Default: ""},
	...
	SubscriptionPlansColumns = []*schema.Column{
		...
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "description", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "billing_mode", Type: field.TypeString, Size: 20, Default: "per_request"},
		{Name: "request_quota", Type: field.TypeInt64, Default: 0},
		{Name: "daily_limit_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "weekly_limit_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
	...
	SubscriptionPlansTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "subscriptionplan_billing_mode",
				Unique:  false,
