...
const acceptUserAgreement = ref<boolean>(false)
...
onMounted(async () => {
  ...
  if (registerDataStr) {
    try {
      ...
      acceptUserAgreement.value = registerData.accept_user_agreement === true
...
async function handleVerify(): Promise<void> {
  ...
  try {
    ...
    await authStore.register({
      ...
      accept_user_agreement: acceptUserAgreement.value
    })
