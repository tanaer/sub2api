...
type OpsRepository interface {
	...
	ListRequestTracesByKey(ctx context.Context, key string, keyType string, limit int) ([]*OpsRequestTrace, error)
	UpsertRequestTrace(ctx context.Context, trace *OpsRequestTrace) error
