...
func init() {
	...
	// apikeyDescRequestQuota is the schema descriptor for request_quota field.
	apikeyDescRequestQuota := apikeyFields[10].Descriptor()
	// apikey.DefaultRequestQuota holds the default value on creation for the request_quota field.
	apikey.DefaultRequestQuota = apikeyDescRequestQuota.Default.(int64)
	// apikeyDescRequestQuotaUsed is the schema descriptor for request_quota_used field.
	apikeyDescRequestQuotaUsed := apikeyFields[11].Descriptor()
	// apikey.DefaultRequestQuotaUsed holds the default value on creation for the request_quota_used field.
	apikey.DefaultRequestQuotaUsed = apikeyDescRequestQuotaUsed.Default.(int64)
	...
	// accountDescUpstreamProvider is the schema descriptor for upstream_provider field.
	accountDescUpstreamProvider := accountFields[6].Descriptor()
	// account.UpstreamProviderValidator is a validator for the "upstream_provider" field. It is called by the builders before save.
	account.UpstreamProviderValidator = accountDescUpstreamProvider.Validators[0].(func(string) error)
	...
	accountthrottleruleDescMatchMode := accountthrottleruleFields[5].Descriptor()
	...
	accountthrottleruleDescTriggerMode := accountthrottleruleFields[6].Descriptor()
	...
	accountthrottleruleDescAccumulatedCount := accountthrottleruleFields[7].Descriptor()
	...
	accountthrottleruleDescAccumulatedWindow := accountthrottleruleFields[8].Descriptor()
	...
	accountthrottleruleDescActionType := accountthrottleruleFields[9].Descriptor()
	...
	accountthrottleruleDescActionDuration := accountthrottleruleFields[10].Descriptor()
	...
	// groupDescFallbackModel is the schema descriptor for fallback_model field.
	groupDescFallbackModel := groupFields[27].Descriptor()
	// group.DefaultFallbackModel holds the default value on creation for the fallback_model field.
	group.DefaultFallbackModel = groupDescFallbackModel.Default.(string)
	// group.FallbackModelValidator is a validator for the "fallback_model" field. It is called by the builders before save.
	group.FallbackModelValidator = groupDescFallbackModel.Validators[0].(func(string) error)
